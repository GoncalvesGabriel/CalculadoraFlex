package br.com.gabrielgoncalves.calculadoraflex.ui.result
...
import br.com.gabrielgoncalves.calculadoraflex.extensions.format
...
class ResultActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(intent.extras == null) {
            Toast.makeText(this, "Não foi possivel realizar operação",
    ...
    private fun calculate() {
        ...
        val ethanolPrice =  intent.extras?.getDouble("ETHENOL_PRICE") ?:  0.0
